...
def run_single_simulation(num_bits=15, noise_rate=0.0):
    ...
    # 1. Configuri il rumore come probabilità pura indipendente dal tempo (0.0 = no caos, 0.5 = caos totale)
    noise_model = DepolarNoiseModel(depolar_rate=noise_rate, time_independent=True)
    
    # 2. CORREZIONE CRUCIALE: la chiave del dizionario deve essere "quantum_noise_model"
    ...
    # Tecniche di controllo: 3 bit sacrificati per la stima, 12 mantenuti
